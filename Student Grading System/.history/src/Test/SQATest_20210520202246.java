...
ArrayList<Rubric> listOfRubrics = new ArrayList<>();
   ...
   public void testAverageForCriterion() {
    ...
    StudentGrade gStudentGrades = controller.addStudentGradeToCriterion(rubric,"Mary",1);
    StudentGrade stGrades = controller.addStudentGradeToCriterion(rubric,"Dan",1);
    StudentGrade gStudentGrade = controller.addStudentGradeToCriterion(rubric,"Gary",4);
    StudentGrade stGrade = controller.addStudentGradeToCriterion(rubric,"Mark",3);
    StudentGrade gStudentGrades = controller.addStudentGradeToCriterion(rubric,"Fergal",1);
    StudentGrade stGrades = controller.addStudentGradeToCriterion(rubric,"Harry",1);
	assertEquals(2.25,controller.getAverageForCriterion(rubric,sQACriterion),0.01);
