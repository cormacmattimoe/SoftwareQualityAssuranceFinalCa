...
ArrayList<Rubric> listOfRubrics = new ArrayList<>();
   ...
   public void testAverageForCriterion() {
    ...
    StudentGrade gStudentGrades = controller.addStudentGradeToCriterion(rubric,"Mary",1);
    StudentGrade stGrades = controller.addStudentGradeToCriterion(rubric,"Dan",1);
    StudentGrade gSt = controller.addStudentGradeToCriterion(rubric,"Gary",4);
    StudentGrade gstudent = controller.addStudentGradeToCriterion(rubric,"Mark",3);
    StudentGrade bStudent = controller.addStudentGradeToCriterion(rubric,"Fergal",1);
    StudentGrade stGlStuddentrades = controller.addStudentGradeToCriterion(rubric,"Harry",1);
