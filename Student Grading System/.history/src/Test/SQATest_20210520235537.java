...
@Test
    ...
    public void testCreateCriterion()
    {
        ...
        assertTrue(controller.addCriterionToRubric(rubric, "C5"));
        assertTrue(controller.addCriterionToRubric(rubric, "C6"));
        assertTrue(controller.addCriterionToRubric(rubric, "C7"));
