...
/*
    ...
    */
    ...
    // Test for creating a student in a rubric
   @Test	
   public void testCreateStudentGrade() {
	   ...
	   assertEquals(new Integer(4),topicMarks.get(designCriterion));
	   assertEquals(new Integer(4),topicMarks.get(testingCriterion));
