...
ArrayList<Rubric> listOfRubrics = new ArrayList<>();
   ...
   public void testGetStudentGrades() {
       ...
       StudentGrade gStudentGrades = controller.addStudentGradeToCriterion(rubric,"Mary",4);
       StudentGrade stGrades = controller.addStudentGradeToCriterion(rubric,"Paul",3);
