...
/*
   ...
   public void testCreateStudentGrade() {
	   Rubric rubric= controller.createNewRubric("Class1");
   ...
   public void testGetGradesInRubric() {
	   Rubric rubric=controller.createNewRubric("Class2");
       String sQACriterion="SQA";
	   String madCriterion="MAD";
	   controller.addCriterionToRubric(rubric, sQACriterion);
	   controller.addCriterionToRubric(rubric, madCriterion);
	   StudentGrade firstGrade = controller.createStudentGrade(rubric,"Tom",2);
	   StudentGrade secondGrade = controller.createStudentGrade(rubric,"Paul",4);
	   assertEquals(2,rubric.getGrades().size());
	   assertEquals("dave",rubric.getGrades().get(0).getStudentName());
	   assertEquals("adam",rubric.getGrades().get(1).getStudentName());
   }
   ...
   public void testAverageForRubric() {
	   ...
	   controller.addCriterionToRubric(rubric, sQACriterion);
	   controller.addCriterionToRubric(rubric, madCriterion);
	   StudentGrade grade=controller.createStudentGrade(rubric,"Tom",4);
