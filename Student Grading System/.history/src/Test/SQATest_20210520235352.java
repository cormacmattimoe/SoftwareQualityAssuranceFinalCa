...
@Test
    ...
    public void testCreateCriterion()
    {
        ...
        assertTrue(controller.addCriterionToRubric(rubric,"Class1"));
        assertTrue(controller.addCriterionToRubric(rubric, "C1"));
        assertTrue(controller.addCriterionToRubric(rubric, "C2"));
        assertTrue(controller.addCriterionToRubric("Class1", "C3"));
        assertTrue(controller.addCriterionToRubric("Class1", "C4"));
        assertTrue(controller.addCriterionToRubric("Class1", "C5"));
        assertTrue(controller.addCriterionToRubric("Class1", "C6"));
        assertTrue(controller.addCriterionToRubric("Class1", "C7"));
