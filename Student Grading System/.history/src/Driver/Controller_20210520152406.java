...
// Calulates Standard Deviation of all grades in rubric
 ...
 /*
    ...
    */
    ...
    //This calculates average of all criterions
	public double getAverageForAllCriterions(Rubric rubric, String criterion) {
		List<StudentGrade> grades = rubric.getStudentGrades();
		double sum=0;
	...
	//This calculates min of all criterions

	public int getAverageForAllCriterions(Rubric rubric, String criterion) {
		...
		//This calculates max of all criterions
	...
	//This calculates standard deviation of all criterions
