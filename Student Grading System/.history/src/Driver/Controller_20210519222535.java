...
//		return sg;
    ...
    public Boolean addStudentGrade(String criteriaName, String rubricame, String nameOfStudent,int gradeOfStudent)
    {
        ...
        for (Rubric r : listOfRubrics)
        {
            if(r.getRubricName() == .getRubricName())
            {
                listOfCriteria = rubricname.getCriteria();
